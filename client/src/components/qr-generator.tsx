...
export default function QRCodeGenerator({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-8 bg-card rounded-2xl shadow-xl border border-border max-w-md w-full mx-auto">
      <div className="relative mb-6 rounded-3xl bg-neutral-900/80 p-4 shadow-2xl shadow-black/40">
        <div className="bg-white p-2 sm:p-3 rounded-2xl border-4 border-black">
          <QRCodeSVG
            value={payload}
            size={qrSize}
            level="M"
